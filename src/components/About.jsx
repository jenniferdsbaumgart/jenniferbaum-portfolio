    ...
    return (
        <div id="about" className="min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="w-full flex items-center justify-between md:justify-center">
                <Image src={'/about-me.png'} alt="About Image" width={400} height={400} className="w-[300px] lg:-[200px] md:hidden"/>
                <div className="max-w-[800px] rounded-xl bg-zinc-100 p-5 text-justify dark:bg-zinc-700 transition-colors">
                    ...
                    <p className="text-lg font-light text-gray-7700 first-letter;pl-3 lg:text-[16px] sm:text[14px] dark:text-white">{aboutText}</p>
                    <a href="/nick-cv.pdf" download="" className="w-max flex items-center gap-x-2 mt-6 rounded-full border-gay-300 bg-red-400 px-3 py-2 font-light text-white hover:bg-red-500 transition-colors">
