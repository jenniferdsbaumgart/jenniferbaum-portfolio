    ...
    <div>
      <button
        ...
        className={`
          ...
          ${language === "en" ? "bg-violet-800" : "bg-gray-400"}
        `}
        style={{ minWidth: 74 }}
      >
        {/* Sliding circle */}
        <span
          className={`
            ...
            w-7 h-7
            bg-gray-300 rounded-full shadow-md
        ...
        >
          {language === "en" ? (
            <span role="img" aria-label="English" className="text-md">🇬🇧</span>
          ) : (
            <span role="img" aria-label="Portuguese" className="text-md">🇧🇷</span>
          )}
        </span>
        {/* Labels */}
        <span className={`absolute left-2 text-xs font-bold pointer-events-none ${language === "en" ? "text-gray-200" : "text-gray-700"}`}>EN</span>
