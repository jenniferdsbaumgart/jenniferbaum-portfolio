...
const Experience = () => {
  ...
  return (
    <div className="relative py-20 px-96">
      ...
      />
      <div ref={containerRef} className="w-full h-full flex flex-col tems-center justify-center gap-y-10 lg:gap-y-20">
        {experienceData.map((data, i) => (
          ...
          >
            <motion.div
              ...
              className="relative flex flex-col gap-y-3 rounded-md border-red-300 bg-white p-4 tracking-wide sm:text-sm"
            >
            ...
            <div
              className={`w-14 absolute top-20 border border-gray-300 rounded-full aspect-square grid place-items-center text-red-400 font-light -translate-y-1/2 z-10 bg-whte ${
                i % 2 === 0
